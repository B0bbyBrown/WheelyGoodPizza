...
export default function Purchases() {
  ...
  const addPurchaseItem = () => {
    setPurchaseItems([...purchaseItems, { ingredientId: "", quantity: "", totalCost: "" }]);
  };
  ...
  return (
    ...
    >
      {/* Action Bar */}
      <div className="flex items-center justify-between mb-6" data-testid="purchases-actions">
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto" data-testid="create-purchase-dialog">
            <DialogHeader>
            ...
            <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-12 gap-4 items-end">
                        <div className="col-span-5">
                          ...
                          <Select 
                            ...
                            onValueChange={(value) => updatePurchaseItem(index, "ingredientId", value)}
                          >
              ...
              <Card className="p-4 bg-muted/50">
                <div className="flex justify-between items-center">
                  <span className="text-lg font-semibold">Total Purchase Cost:</span>
        ...
        <CardContent>
          {purchasesLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-muted-foreground">Create your first purchase order to track inventory</p>
            </div>
          ) : (
            <Table data-testid="purchases-table">
              ...
              <TableBody>
                {purchases.map((purchase: any, index: number) => (
                  <TableRow key={purchase.id} data-testid={`purchase-row-${index}`}>
                    ...
                    <TableCell>
                      {purchase.supplierId ? (
                        suppliers.find((s: any) => s.id === purchase.supplierId)?.name || "Unknown"
                      ) : (
                        <span className="text-muted-foreground">No supplier</span>
                      )}
                    </TableCell>
                    <TableCell>
                      <span className="text-sm text-muted-foreground">Multiple items</span>
                    </TableCell>
